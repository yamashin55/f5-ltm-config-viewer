...
const elMapping = document.getElementById("id_mapping");
...
// VS + Default Pool Member Mapping (Click)
elMapping.onclick = async () => {
  try {
    ...
    var headTable = `<table class="tableclass table-div" id="id_vsPoolTable"><thead><tr>
    <th>Virtual_Server_NAME</th>
    <th>Virtual_Server_Address</th>
    <th>Virtual_Server_Pool</th>
    <th>Pool_Member</th>
    </tr></thead><tbody>
    `
    var bodyTable = ""
    var foodTable = "</tbody></table>"
    var table = ""
    ...
    var table_vspool = $(table).DataTable();
    var vspoolData = table_vspool.rows().data().toArray();
...
// // Build DataTables
// var table_vspool = $('#id_vsPoolTable').DataTable();
// var vspoolData = table_vspool.rows().data().toArray();
// console.log(vspoolData);